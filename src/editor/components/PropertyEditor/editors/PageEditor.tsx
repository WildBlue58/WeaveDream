    ...
    <div className="space-y-1">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className={formItemStyle}>
          ...
          <InputNumber
            value={
              currentProps.padding !== undefined ? currentProps.padding : 32
            }
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className={formItemStyle}>
          ...
          <InputNumber
            value={
              currentProps.minHeight !== undefined
                ? currentProps.minHeight
                : 600
            }
            onChange={(value) => handleChange("minHeight", value || 600)}
            min={200}
            max={2000}
            className="w-full transition-all duration-200"
          />
